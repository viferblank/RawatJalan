...
<form action="index.php?menu=dokter" method="post">
	<div width="300" align="right" cellpadding="0" cellspacing="0" border="0" style="border:0px; background:#09f;">
	<tr bgcolor="#09f">
	<td width="236" align="right"></td>
	<td bgcolor="#09f"> <input type="text" name="cari" value=" Search dokter" class="search-form"  onBlur="javascript:if(this.value==''){this.value=this.defaultValue;}" onFocus="javascript:if(this.value==this.defaultValue){this.value='';}"  /></td>
	<td bgcolor="#09f"><input type="submit" name="submit" value="search" style="border: 1px solid #ccc; padding:5px; vertical-align:middle;" />
	</td>
	</tr>
	</div>
	</form>
